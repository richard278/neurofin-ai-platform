...
Start with the technical documentation index for current capabilities, future designs, and historical plans. Architecture decisions are recorded in backend/docs/adr/.
